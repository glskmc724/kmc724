// ======================================================================
// BLE_IMU.v generated from TopDesign.cysch
// 07/12/2023 at 18:07
...
module top ;
	...
	wire [0:0] tmpOE__UART_DBG_RX_net;
	wire [0:0] tmpIO_0__UART_DBG_RX_net;
	wire [0:0] tmpINTERRUPT_0__UART_DBG_RX_net;
	electrical [0:0] tmpSIOVREF__UART_DBG_RX_net;

	cy_psoc3_pins_v1_10
		#(.id("f44babab-c4c8-4900-b87d-997cb5c87df1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		UART_DBG_RX
		 (.oe(tmpOE__UART_DBG_RX_net),
		  .y({1'b0}),
		  .fb({Net_225}),
		  .io({tmpIO_0__UART_DBG_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_DBG_RX_net),
		  .interrupt({tmpINTERRUPT_0__UART_DBG_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_DBG_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UART_DBG_TX_net;
	wire [0:0] tmpFB_0__UART_DBG_TX_net;
	wire [0:0] tmpIO_0__UART_DBG_TX_net;
	wire [0:0] tmpINTERRUPT_0__UART_DBG_TX_net;
	electrical [0:0] tmpSIOVREF__UART_DBG_TX_net;

	cy_psoc3_pins_v1_10
		#(.id("8bae99a5-133d-47c4-99f7-4c25750ac295"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UART_DBG_TX
		 (.oe(tmpOE__UART_DBG_TX_net),
		  .y({Net_226}),
		  .fb({tmpFB_0__UART_DBG_TX_net[0:0]}),
		  .io({tmpIO_0__UART_DBG_TX_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_DBG_TX_net),
		  .interrupt({tmpINTERRUPT_0__UART_DBG_TX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_DBG_TX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v4_0_1 UART_IMU (
        .cts_in(1'b0),
        .rts_out(Net_44),
        .interrupt(Net_45),
        .clock(1'b0),
	...
	wire [0:0] tmpOE__UART_IMU_RX_net;
	wire [0:0] tmpIO_0__UART_IMU_RX_net;
	wire [0:0] tmpINTERRUPT_0__UART_IMU_RX_net;
	electrical [0:0] tmpSIOVREF__UART_IMU_RX_net;

	cy_psoc3_pins_v1_10
		#(.id("268f7285-6c72-4422-ba97-1d121ad69ba7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UART_IMU_RX
		 (.oe(tmpOE__UART_IMU_RX_net),
		  .y({1'b0}),
		  .fb({Net_60}),
		  .io({tmpIO_0__UART_IMU_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_IMU_RX_net),
		  .interrupt({tmpINTERRUPT_0__UART_IMU_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_IMU_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UART_IMU_TX_net;
	wire [0:0] tmpFB_0__UART_IMU_TX_net;
	wire [0:0] tmpIO_0__UART_IMU_TX_net;
	wire [0:0] tmpINTERRUPT_0__UART_IMU_TX_net;
	electrical [0:0] tmpSIOVREF__UART_IMU_TX_net;

	cy_psoc3_pins_v1_10
		#(.id("a40623b8-1601-4083-9631-adfdefec544c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UART_IMU_TX
		 (.oe(tmpOE__UART_IMU_TX_net),
		  .y({Net_61}),
		  .fb({tmpFB_0__UART_IMU_TX_net[0:0]}),
		  .io({tmpIO_0__UART_IMU_TX_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_IMU_TX_net),
		  .interrupt({tmpINTERRUPT_0__UART_IMU_TX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_IMU_TX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
