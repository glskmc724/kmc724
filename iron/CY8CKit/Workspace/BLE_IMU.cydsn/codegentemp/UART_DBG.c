...
static void UART_DBG_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void UART_DBG_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            UART_DBG_RX_SDA_MOSI_HSIOM_SEL_GPIO,
            UART_DBG_TX_SCL_MISO_HSIOM_SEL_GPIO,
            0u,
            0u,
            0u,
            0u,
            ...
            (UART_DBG_SCB_MODE_EZI2C == mode))
        {
            ...
            hsiomSel[UART_DBG_RX_SDA_MOSI_PIN_INDEX] = UART_DBG_RX_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [UART_DBG_RX_SDA_MOSI_PIN_INDEX] = UART_DBG_PIN_DM_OD_LO;
        #elif (UART_DBG_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[UART_DBG_RX_WAKE_SDA_MOSI_PIN_INDEX] = UART_DBG_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [UART_DBG_RX_WAKE_SDA_MOSI_PIN_INDEX] = UART_DBG_PIN_DM_OD_LO;
        #else
        #endif /* (UART_DBG_RX_SDA_MOSI_PIN) */
        
        #if (UART_DBG_TX_SCL_MISO_PIN)
            hsiomSel[UART_DBG_TX_SCL_MISO_PIN_INDEX] = UART_DBG_TX_SCL_MISO_HSIOM_SEL_I2C;
        ...
        {
        #if (UART_DBG_RX_SDA_MOSI_PIN)
            hsiomSel[UART_DBG_RX_SDA_MOSI_PIN_INDEX] = UART_DBG_RX_SDA_MOSI_HSIOM_SEL_SPI;
        #elif (UART_DBG_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[UART_DBG_RX_WAKE_SDA_MOSI_PIN_INDEX] = UART_DBG_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI;
        #else
        #endif /* (UART_DBG_RX_SDA_MOSI_PIN) */
        
        #if (UART_DBG_TX_SCL_MISO_PIN)
            hsiomSel[UART_DBG_TX_SCL_MISO_PIN_INDEX] = UART_DBG_TX_SCL_MISO_HSIOM_SEL_SPI;
        #endif /* (UART_DBG_TX_SCL_MISO_PIN) */
        ...
        else /* UART */
        {
            if (UART_DBG_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (UART_DBG_TX_SCL_MISO_PIN)
                hsiomSel[UART_DBG_TX_SCL_MISO_PIN_INDEX] = UART_DBG_TX_SCL_MISO_HSIOM_SEL_UART;
                pinsDm  [UART_DBG_TX_SCL_MISO_PIN_INDEX] = UART_DBG_PIN_DM_OD_LO;
            #endif /* (UART_DBG_TX_SCL_MISO_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (UART_DBG_RX_SDA_MOSI_PIN)
                    hsiomSel[UART_DBG_RX_SDA_MOSI_PIN_INDEX] = UART_DBG_RX_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [UART_DBG_RX_SDA_MOSI_PIN_INDEX] = UART_DBG_PIN_DM_DIG_HIZ;
                #elif (UART_DBG_RX_WAKE_SDA_MOSI_PIN)
                    hsiomSel[UART_DBG_RX_WAKE_SDA_MOSI_PIN_INDEX] = UART_DBG_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [UART_DBG_RX_WAKE_SDA_MOSI_PIN_INDEX] = UART_DBG_PIN_DM_DIG_HIZ;
                #else
                #endif /* (UART_DBG_RX_SDA_MOSI_PIN) */
                }
