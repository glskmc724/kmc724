...
#define UART_DBG_SPI_INTR_RX_MASK           (0x0u)
#define UART_DBG_SPI_INTR_TX_MASK           (0x0u)
...
#define UART_DBG_UART_OVS_FACTOR            (12u)
...
#define UART_DBG_UART_MP_RX_ADDRESS         (0x2u)
#define UART_DBG_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define UART_DBG_UART_INTERRUPT_MODE        (0u)

#define UART_DBG_UART_INTR_RX_MASK          (0x0u)
#define UART_DBG_UART_INTR_TX_MASK          (0x0u)
...
#define UART_DBG_UART_RX_BREAK_WIDTH        (11u)
...
****************************************/
    ...
    #define UART_DBG_CHECK_SPI_WAKE_ENABLE  ((0u != UART_DBG_scbEnableWake) && UART_DBG_SCB_MODE_SPI_RUNTM_CFG)
    #define UART_DBG_CHECK_UART_WAKE_ENABLE ((0u != UART_DBG_scbEnableWake) && UART_DBG_SCB_MODE_UART_RUNTM_CFG)
    ...
    /* Internal RX and TX buffer: for SPI or UART */
        ...
        /* Get FIFO size */
        #define UART_DBG_SPI_UART_FIFO_SIZE UART_DBG_GET_FIFO_SIZE(UART_DBG_SPI_BYTE_MODE_ENABLE)
        ...
        /* Get FIFO size */
        #define UART_DBG_SPI_UART_FIFO_SIZE UART_DBG_GET_FIFO_SIZE(UART_DBG_UART_BYTE_MODE_ENABLE)
    ...
    #define UART_DBG_CHECK_UART_WAKE_ENABLE (UART_DBG_UART_WAKE_ENABLE_CONST)
...
typedef struct
{
    ...
    */
     ...
     *  choices:
     *  - UART_DBG_SPI_MODE_MOTOROLA
     *  - UART_DBG_SPI_MODE_TI_COINCIDES
     *  - UART_DBG_SPI_MODE_TI_PRECEDES
     *  - UART_DBG_SPI_MODE_NATIONAL
    */
    uint32 submode;
     ...
     *  - UART_DBG_SPI_SCLK_CPHA0_CPOL0
     *  - UART_DBG_SPI_SCLK_CPHA0_CPOL1
     *  - UART_DBG_SPI_SCLK_CPHA1_CPOL0
     *  - UART_DBG_SPI_SCLK_CPHA1_CPOL1
    */
    uint32 sclkMode;
    ...
    */
     ...
     *  choices:
     *  - UART_DBG_BITS_ORDER_LSB_FIRST
     *  - UART_DBG_BITS_ORDER_MSB_FIRST
    */
    uint32 bitOrder;
     ...
     *  available choices:
     *  - UART_DBG_SPI_TRANSFER_CONTINUOUS
     *  - UART_DBG_SPI_TRANSFER_SEPARATED
    */
     ...
     *  buffer.
     *  The UART_DBG_INTR _RX_NOT_EMPTY interrupt has to be enabled to
    ...
    */
     ...
     *  UART_DBG_SPI_SLAVE_SELECT0 corresponds to slave select 0
     *  polarity, bit UART_DBG_SPI_SLAVE_SELECT1 – slave select 1
     *  polarity and so on. Polarity constants are:
     *  - UART_DBG_SPI_SS_ACTIVE_LOW
     *  - UART_DBG_SPI_SS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE /
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S /
     *  PSoC Analog Coprocessor.
...
typedef struct
{
     ...
     *  choices:
     *  - UART_DBG_UART_MODE_STD
     *  - UART_DBG_UART_MODE_SMARTCARD
     *  - UART_DBG_UART_MODE_IRDA
    */
    uint32 mode;
    ...
    */
     ...
     *  - UART_DBG_UART_PARITY_EVEN
     *  - UART_DBG_UART_PARITY_ODD
     *  - UART_DBG_UART_PARITY_NONE
    */
    uint32 parity;

    /** Determines the number of stop bits. The following defines are available
     *  choices:
     *  - UART_DBG_UART_STOP_BITS_1
     *  - UART_DBG_UART_STOP_BITS_1_5
     *  - UART_DBG_UART_STOP_BITS_2
    */
    uint32 stopBits;
     ...
     *  is enabled:
     *  - UART_DBG_UART_IRDA_LP_OVS16
     *  - UART_DBG_UART_IRDA_LP_OVS32
     *  - UART_DBG_UART_IRDA_LP_OVS48
     *  - UART_DBG_UART_IRDA_LP_OVS96
     *  - UART_DBG_UART_IRDA_LP_OVS192
     *  - UART_DBG_UART_IRDA_LP_OVS768
     *  - UART_DBG_UART_IRDA_LP_OVS1536
    */
    uint32 oversample;
    ...
    */
     ...
     *  - UART_DBG_UART_CTS_ACTIVE_LOW
     *  - UART_DBG_UART_CTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE /
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S /
     *  PSoC Analog Coprocessor.
    ...
    */
     ...
     *  - UART_DBG_UART_RTS_ ACTIVE_LOW
     *  - UART_DBG_UART_RTS_ACTIVE_HIGH
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE /
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S /
     *  PSoC Analog Coprocessor.
...
/* SPI specific functions */
    ...
    /*******************************************************************************
    * Function Name: UART_DBG_SpiIsBusBusy
    ****************************************************************************//**
    *
...
/* UART specific functions */
    ...
    /* UART TX direction APIs */
        ...
        /*******************************************************************************
        * Function Name: UART_DBG_UartPutChar
        ****************************************************************************//**
        *
        ...
        *  Use UART_DBG_UART_MP_MARK to add a mark to create an address byte.
        *
...
#define UART_DBG_INTR_SPIM_TX_RESTORE   (UART_DBG_INTR_TX_OVERFLOW)

#define UART_DBG_INTR_SPIS_TX_RESTORE     (UART_DBG_INTR_TX_OVERFLOW | \
                                                 UART_DBG_INTR_TX_UNDERFLOW)
...
#define UART_DBG_INTR_UART_TX_RESTORE   (UART_DBG_INTR_TX_OVERFLOW  | \
                                                 UART_DBG_INTR_TX_UART_NACK | \
                                                 UART_DBG_INTR_TX_UART_DONE | \
                                                 UART_DBG_INTR_TX_UART_ARB_LOST)
...
***************************************/
    ...
    extern uint8 UART_DBG_skipStart;
...
***************************************/
    ...
    #define UART_DBG_UART_DEFAULT_UART_RX_CTRL \
                    (UART_DBG_GET_UART_RX_CTRL_MODE(UART_DBG_UART_STOP_BITS_NUM)                    | \
                     ...
                     UART_DBG_GET_UART_RX_CTRL_BREAK_WIDTH(UART_DBG_UART_RX_BREAK_WIDTH)            | \
