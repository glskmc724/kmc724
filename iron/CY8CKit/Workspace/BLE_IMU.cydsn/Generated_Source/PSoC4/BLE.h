...
#define CYBLE_GATT_MAX_ATTR_LEN             ((0x0004u == 0u) ? (1u) : (0x0004u))
...
#define CYBLE_L2CAP_ENABLE                              (1u)
    ...
    /* L2CAP MTU Size */
    #define CYBLE_L2CAP_MTU                             (512u)
    /* L2CAP PMS Size */
    #define CYBLE_L2CAP_MPS                             (512u)
...
#if(CYBLE_MODE_PROFILE)
    #if(CYBLE_M0S8BLESS_VERSION_2)
        #define CYBLE_LL_MAX_TX_PAYLOAD_SIZE            (0xFBu)
        #define CYBLE_LL_MAX_RX_PAYLOAD_SIZE            (0xFBu)
